...
public class ApplicationContextConfigurationDev {
    ...
    public void devLogger() {
        ...
        try (FileInputStream is = new FileInputStream(log4jPropertiesPath)) {
            ...
            log.info("log4j-dev.properties file received successfully!");
        } catch (IOException ex) {
            log.error("log4j-dev.properties file is not available!");
        }
    }
