...
public class DoctorServiceImplTest {
    ...
    void getAllDoctors_validData_shouldReturnDoctorsList() {
        ...
        when(userRepository.findAllByRolesName(RoleType.DOCTOR))
...
//        when(userRepository.deleteById(not(eq(1)))).thenReturn(false);
//
//        //when
...
//        //given
//        when(userRepository.deleteById(1)).thenThrow(new RepositoryException("some msg"));
//
//        //when && then
